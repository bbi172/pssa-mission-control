    ...
    <div className="marketing-site">
      <div className="bg-graphic">
        <svg viewBox="0 0 820 820" xmlns="http://www.w3.org/2000/svg">
          <circle cx="150" cy="600" r="220" fill="#7a1f2b" opacity="0.05"/>
          <circle cx="80" cy="720" r="140" fill="#16233f" opacity="0.06"/>
          <path d="M 100 780 C 250 700, 300 500, 200 350" stroke="#7a1f2b" strokeWidth="1.5" fill="none" opacity="0.1"/>
          <circle cx="180" cy="450" r="4" fill="#16233f" opacity="0.3"/>
          <circle cx="60" cy="600" r="3" fill="#7a1f2b" opacity="0.3"/>
        </svg>
      </div>
